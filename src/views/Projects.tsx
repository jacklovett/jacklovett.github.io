    ...
    <div className="projects-view">
        <section className="soundid center project-content">
            ...
            <div className="content center">
                <div className="project-description">
                    ...
                    <p>
                        SoundID creates a unique sound profile for each user by
                        analysing their individual taste and hearing
                        capabilities.
                    </p>
                    <p>
        ...
        <section className="samaritans center project-content">
            ...
            <div className=" center content">
                ...
                <div className="project-description">
                    <p>
                        An anonymous live chat service for Samaritan charities,
                        aiming to connect people in need while protecting
                        participants identity. This project includes a
                        public-facing chat app and a private back-office
                        application for managing user accounts and chat
                        configurations.
                    </p>
                    <p>
        ...
        <section className="tic-stat-toe center project-content">
            <div className="center content">
                ...
                <div className="project-description">
                    <p>
                        Tic-Stat-Toe builds on the classic Tic-tac-toe game by
                        tracking various metrics, such as average game length
                        and common first moves. It offers insights into player
                        behavior and game trends, revealing interesting patterns
                        and dynamics.
                    </p>
                    <p>
                        {`Check it out here on `}
